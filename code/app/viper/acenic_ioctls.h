...
#define ACENIC_IOCTL_RTT_EXP    (SIOCDEVPRIVATE + 2)
#define ACENIC_IOCTL_RTT_EXP2   (SIOCDEVPRIVATE + 3)
#define ACENIC_IOCTL_SWATT      (SIOCDEVPRIVATE + 4)
#define ACENIC_IOCTL_SWATT_B      (SIOCDEVPRIVATE + 9)
#define ACENIC_IOCTL_SWATT_READ_SHA1 (SIOCDEVPRIVATE + 10)
